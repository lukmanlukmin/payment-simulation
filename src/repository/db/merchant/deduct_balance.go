...
// DeductBalance ...
func (r *Repository) DeductBalance(ctx context.Context, id int64, amount decimal.Decimal, expectedVersion int64) (newBalance decimal.Decimal, newVersion int64, err error) {
